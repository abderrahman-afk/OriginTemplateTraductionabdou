...
@Component({
  ...
  templateUrl: './aggridevalagent.component.html',
  styleUrls: ['./aggridevalagent.component.scss']
})
export class AggridevalagentComponent implements OnInit {
